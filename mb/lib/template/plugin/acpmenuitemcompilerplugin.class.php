...
class AcpMenuItemCompilerPlugin implements TemplateCompilerPlugin {
    ...
    public function execute(array $args, TemplateCompiler $compiler) {
        ...
        //HTML
        $html .= '<div class="mb-view-acp-menuItem" id="a'. $randomStr .'">';
        $html .= '<span class="mb-view-acp-menuItem-icon" id='. $args['icon'] .'></span>';
        $html .= '<span class="mb-view-acp-menuItem-text"><?php echo \\RWF\\Core\\RWF::getLanguage()->get('. $args['text'] .'); ?></span>';
        $html .= '</div>';
