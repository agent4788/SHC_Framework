...
class ContentBoxCompilerBlockPlugin implements TemplateCompilerBlockPlugin {
    ...
    public function executeStart(array $args, TemplateCompiler $compiler) {
        ...
        $html = '<div class="mb-contentbox ui-tabs ui-widget ui-widget-content ui-corner-all '. $class .'"'. $id .'>';
        $html .= '<div class="mb-contentbox-header ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all">';
        $html .= $name;
        $html .= '</div>';
        $html .= '<div class="mb-contentbox-inner">';
        return $html;
    }
