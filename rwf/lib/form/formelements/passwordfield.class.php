...
class PasswordField extends AbstractFormElement {
    ...
    protected function fetchWebView() {
        ...
        $html .= '<input type="password" name="' . StringUtils::encodeHTML($this->getName()) . '" class="rwf-ui-form-content-passwordfield' . $class . '" value="" ' . $id . $options . $disabled . ' />';
        $html .= "</div>\n";
    ...
    protected function fetchMobileView() {
        ...
        //Formularfeld
        $html .= '<input type="password" name="' . StringUtils::encodeHTML($this->getName()) . '" class="rwf-ui-form-content-passwordfield" value="" ' . $id . $options . $disabled . ' />';
