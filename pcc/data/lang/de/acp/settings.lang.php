...
$l['acp.settings.form.fbShowState.decription'] = 'Soll die Frit!Box Statusübersicht angezeigt werden';
$l['acp.settings.form.fbCallList'] = 'Anrufliste';
$l['acp.settings.form.fbCallList.decription'] = 'Soll die Frit!Box Anrufliste angezeigt werden';
...
$l['acp.settings.form.fbLog.decription'] = 'Soll die Frit!Box Log angezeigt werden';
