...
class DeleteLinkCompilerPlugin implements TemplateCompilerPlugin {
    ...
    public function execute(array $args, TemplateCompiler $compiler) {
        ...
        $html .= '<a href="#"  id="<?php echo $randomId; ?>" class="pcc-view-buttons-delete" title="<?php echo \\RWF\\Core\\RWF::getLanguage()->get(\'global.button.delete\'); ?>"></a>';
        if($safetyPromptText != '') {
        ...
        $html .= '$(function() {';
        $html .= '  $(\'.pcc-view-buttons-delete\').tooltip({';
        $html .= '      track: false,';
        $html .= '      position: {';
