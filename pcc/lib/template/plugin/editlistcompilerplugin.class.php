...
class EditListCompilerPlugin implements TemplateCompilerPlugin {
    ...
    public function execute(array $args, TemplateCompiler $compiler) {
        ...
        $html .= '<a href="#"  id="<?php echo $randomId; ?>" class="pcc-view-buttons-editlist" title="<?php echo \\RWF\\Core\\RWF::getLanguage()->get(\'global.button.editlist\'); ?>"></a>';
        $html .= '<script type="text/javascript">';
        $html .= '$(function() {';
        $html .= '  $(\'.pcc-view-buttons-edit\').tooltip({';
        $html .= '      track: false,';
        $html .= '      position: {';
