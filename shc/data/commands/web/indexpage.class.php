...
class IndexPage extends PageCommand {
    ...
    public function processData() {
        ...
        $form->setView(\RWF\Form\Form::TABLET_VIEW);
        $form->addFormElement((new \RWF\Form\FormElements\TextField('test', 'test123', array('minlength' => 3, 'maxlength' => 15)))->setTitle('Test 1')->requiredField(true));
        ...
        $form->addFormElement((new \RWF\Form\FormElements\IntegerInputField('test4', '500', array('min' => -100, 'max' => 1000, 'step' => 50)))->setTitle('Test 4'));
        ...
        $form->addFormElement((new \RWF\Form\FormElements\OnOffOption('test6', true))->setOnOffLabel()->setTitle('Test 6'));
        $form->addFormElement((new \RWF\Form\FormElements\CheckBoxes('test7', array(1 => 'Test 1', 2 => array('Test 2', 1))))->setTitle('Test 7')->requiredField(true));
