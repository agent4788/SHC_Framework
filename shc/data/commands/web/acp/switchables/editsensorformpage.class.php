        ...
        if($sensor instanceof BMP) {
            ...
            if($sct013Form->isSubmitted() && $sct013Form->validate()) {
                ...
                try {
                    ...
                    SensorPointEditor::getInstance()->editCometDectRadiatoThermostatSensor($sensorId, $name, $icon, $rooms, null, $visibility, $distanceVisibility, $dataRecording, $distanceOffset);
                    $message->setType(Message::SUCCESSFULLY);
                    $message->setMessage(RWF::getLanguage()->get('acp.switchableManagement.form.editSensor.success'));
                } catch(\Exception $e) {
