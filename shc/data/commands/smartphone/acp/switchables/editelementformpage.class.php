...
class EditElementFormPage extends PageCommand {
    ...
    public function processData() {
        ...
        if($element instanceof Activity) {
            ...
            $edimaxSocketForm->setAction('index.php?app=shc&m&page=editelementform&id='. $element->getId());
            $edimaxSocketForm->setView(Form::SMARTPHONE_VIEW);
            ...
            $virtualSocket->setAction('index.php?app=shc&m&page=editelementform&id='. $element->getId());
