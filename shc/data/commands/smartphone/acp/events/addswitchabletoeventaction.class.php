 ...
 * @version    2.0.0-0
 */
class AddSwitchableToEventAction extends ActionCommand {
     ...
     * @var String
     */
    protected $location = 'index.php?app=shc&m&page=manageswitchablesinevents&id=';
    ...
    public function executeAction() {
        ...
        if($event instanceof Event) {
            ...
            $this->location = 'index.php?app=shc&m&page=listevents';
