...
//$l['sensorTransmitter.input.active.invalid'] = 'Invalid input';
...
$l['sensorTransmitter.input.active.invalid.repeated'] = 'You have entered too many times an invalid data';
//$l['sensorTransmitter.input.ip'] = 'IP Adresse des Sensor Empfängers ({1:s}): ';
$l['sensorTransmitter.input.ip'] = 'IP Adress of sensor receiver ({1:s}): ';
//$l['sensorTransmitter.input.ip.invalid'] = 'ungültige IP Adresse!';
$l['sensorTransmitter.input.ip.invalid'] = 'invalid IP Adress!';
//$l['sensorTransmitter.input.ip.invalid.repeated'] = 'du hast zu oft eine ungültige Adressen eingegeben';
$l['sensorTransmitter.input.ip.invalid.repeated'] = 'You have entered too many times an invalid addresses';
//$l['sensorTransmitter.input.port'] = 'Port des Sensor Empfängers ({1:s}): ';
$l['sensorTransmitter.input.port'] = 'Port of sensor receiver ({1:s}): ';
...
$l['sensorTransmitter.input.port.invalid.repeated'] = 'You have entered too many times an invalid port';
//$l['sensorTransmitter.input.sensorPointId'] = 'Sensor Punkt ID ({1:s}): ';
$l['sensorTransmitter.input.sensorPointId'] = 'Sensor Point ID ({1:s}): ';
//$l['sensorTransmitter.input.sensorPointId.invalid'] = 'ungültige ID';
$l['sensorTransmitter.input.sensorPointId.invalid'] = 'invalid ID';
//$l['sensorTransmitter.input.sensorPointId.invalid.repeated'] = 'du hast zu oft eine ungültige ID eingegeben';
$l['sensorTransmitter.input.sensorPointId.invalid.repeated'] = 'You have entered too many times an invalid ID';
...
$l['sensorTransmitter.input.sensorPointId.info'] = 'The sensor point ID must be unique throughout the network, over this ID the sensor can be assigned better to a location';
...
$l['sensorTransmitter.input.blinkPin.invalid'] = 'invalid input';
//$l['sensorTransmitter.input.blinkPin.invalid.repeated'] = 'du hast zu oft eine ungültige Angaben eingegeben';
$l['sensorTransmitter.input.blinkPin.invalid.repeated'] = 'You have entered too many times an invalid data';
...
$l['sensorTransmitter.input.save.success'] = 'The settings have been successfully saved and will be active after the next reboot of the server';
//$l['sensorTransmitter.input.save.error'] = 'Die Einstellungen konnten nicht gespeichert werden';
$l['sensorTransmitter.input.save.error'] = 'The settings could not be saved';
