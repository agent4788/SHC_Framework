...
$l['acp.settings.form.success'] = 'The settings have been successfully saved';
...
$l['acp.settings.tabs.dateTime'] = 'Date snd time';
//$l['acp.settings.tabs.dateTime.description'] = 'Zeiteinstellungen zu Datum und Zeit';
$l['acp.settings.tabs.dateTime.description'] = 'Time settings for date and time';
...
$l['acp.settings.tabs.ui.description'] = 'Settings to the user interface';
$l['acp.settings.tabs.fritzBox'] = 'Fritz!Box';
//$l['acp.settings.tabs.fritzBox.description'] = 'Zugangsdaten zur Fritz Box';
$l['acp.settings.tabs.fritzBox.description'] = 'Login information to the Fritz box';
...
$l['acp.settings.tabs.redirect.smartphone'] = 'Mobile interface';
//$l['acp.settings.tabs.timeline.true'] = 'Intervall (vor 5 Minuten)';
$l['acp.settings.tabs.timeline.true'] = 'Interval (5 minutes ago)';
//$l['acp.settings.tabs.timeline.false'] = 'Absolut (11.05.2014 11:15:36)';
$l['acp.settings.tabs.timeline.false'] = 'Absolut (05/11/2014 11:15:36)';
//$l['acp.settings.form.title'] = 'Titel';
$l['acp.settings.form.title'] = 'Title';
//$l['acp.settings.form.title.decription'] = 'Titel der in der Kopfzeile angezeigt wird';
...
$l['acp.settings.form.allowLongTimeLogin'] = 'Long time login';
...
$l['acp.settings.form.defaultStyle.decription'] = 'the webstyle configured here applies for all guests and users who do not select a style itself';
...
$l['acp.settings.form.defaultLanguage.decription'] = 'the language configured here applies for all guests and users who do not select a style itself';
...
$l['acp.settings.form.defaultDateFormat.decription'] = 'Default date format, the meaning of the formatting is in the PHP function description of function  "date"';
...
$l['acp.settings.form.defaultTimeFormat.decription'] = 'Default time format, the meaning of the formatting is in the PHP function description of function  "date"';
//$l['acp.settings.form.useTimeline'] = 'Zeitanzeige';
$l['acp.settings.form.useTimeline'] = 'Time display';
//$l['acp.settings.form.useTimeline.decription'] = 'legt fest wie Datum un Urzeit angezeigt werden sollen';
$l['acp.settings.form.useTimeline.decription'] = 'specifies how the date and time have to be displayed';
...
$l['acp.settings.form.sunriseOffset.decription'] = 'with this setting, the calculated sunrise can be moved (todays sunrise with Offset: {1: s} clock)';
...
$l['acp.settings.form.sunsetOffset.decription'] = 'with this setting, the calculated sunset can be moved (todays sunrise with Offset: {1: s} clock)';
//$l['acp.settings.form.Latitude'] = 'Breitengrad';
$l['acp.settings.form.Latitude'] = 'Degree of latitude';
//$l['acp.settings.form.Latitude.decription'] = 'Geodaten für die Berechnung von Sonnenauf- und untergang';
$l['acp.settings.form.Latitude.decription'] = 'Geo data for the calculation of sunrise and sunset';
//$l['acp.settings.form.Longitude'] = 'Längengrad';
$l['acp.settings.form.Longitude'] = 'Degree of longitude';
//$l['acp.settings.form.Longitude.decription'] = 'Geodaten für die Berechnung von Sonnenauf- und untergang';
$l['acp.settings.form.Longitude.decription'] = 'Geo data for the calculation of sunrise and sunset';
...
$l['acp.settings.form.fbAddress.decription'] = 'Host or IP address of the Fritz!Box';
//$l['acp.settings.form.5GHzWlan'] = '5GHz Wlan';
$l['acp.settings.form.5GHzWlan'] = '5GHz WLAN ';
//$l['acp.settings.form.5GHzWlan.decription'] = 'Hat die Fritz!Box ein 5GHz Wlan?';
$l['acp.settings.form.5GHzWlan.decription'] = 'Does the Fritz!Box have a 5GHz WLAN?';
...
$l['acp.settings.form.redirectActive.decription'] = 'is the redirection active PCs, tablets and smartphones are redirected to the recruited surfaces';
...
$l['acp.settings.form.redirectPcTo.decription'] = 'Set the surface on the PC will be redirected';
...
$l['acp.settings.form.redirectTabletTo.decription'] = 'Set the surface on the tablet will be redirected';
//$l['acp.settings.form.redirectSmartphoneTo'] = 'Smartphone Umleitung';
$l['acp.settings.form.redirectSmartphoneTo'] = 'Smartphone redirection';
//$l['acp.settings.form.redirectSmartphoneTo.decription'] = 'legt die Oberfläche fest auf die ein Smartphone umgeleitet wird';
$l['acp.settings.form.redirectSmartphoneTo.decription'] = 'Set the surface on the smartphone will be redirected';
//$l['acp.settings.form.showUsersAtHome'] = 'Benutzer zu Hause Anzeigen';
$l['acp.settings.form.showUsersAtHome'] = 'Display users at home';
...
$l['acp.settings.form.showUsersAtHome.decription'] = 'if active users are displayed at home with their current status on the start page';
