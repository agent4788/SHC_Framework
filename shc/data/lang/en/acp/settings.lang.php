...
$l['acp.settings.tabs.ui.description'] = 'Einstellungen zur Benutzeroberfläche';
$l['acp.settings.tabs.fritzBox'] = 'Settings to the user interface';
...
$l['acp.settings.form.sunriseOffset.decription'] = 'with this setting, the calculated sunrise can be moved (today's sunrise with Offset: {1: s} clock)';
...
$l['acp.settings.form.sunsetOffset.decription'] = 'with this setting, the calculated sunset can be moved (today's sunrise with Offset: {1: s} clock)';
