...
$l['acp.userManagement.title'] = 'User administration';
...
$l['acp.userManagement.groupList.table.head.sysGroup'] = 'Systemgroup';

//Buttons
//Buttons

//$l['acp.userManagement.button.addUser'] = 'neuer Benutzer';
$l['acp.userManagement.button.addUser'] = 'Add user';
//$l['acp.userManagement.button.viewGroupList'] = 'Benutzergruppen';
$l['acp.userManagement.button.viewGroupList'] = 'Usergroups';
//$l['acp.userManagement.button.addGroup'] = 'neue Benutzergruppe';
$l['acp.userManagement.button.addGroup'] = 'Add usergroup';
...
$l['acp.userManagement.form.user.addDescription'] = 'Ceate user';
...
$l['acp.userManagement.form.user.name'] = 'Username';
//$l['acp.userManagement.form.user.name.description'] = 'Name des Benutzers';
$l['acp.userManagement.form.user.name.description'] = 'Name of user';
...
$l['acp.userManagement.form.user.pass1.description'] = 'Password of user';
...
$l['acp.userManagement.form.user.pass2.description'] = 'enter the password again to avoid spelling errors';
//$l['acp.userManagement.form.user.mainGroup'] = 'Hauptgruppe';
$l['acp.userManagement.form.user.mainGroup'] = 'Maingroup';
//$l['acp.userManagement.form.user.mainGroup.description'] = 'Hauptgruppe des Benutzers';
$l['acp.userManagement.form.user.mainGroup.description'] = 'Maingroup of user';
...
$l['acp.userManagement.form.user.webStyle.description'] = 'Style of web interface';
...
$l['acp.userManagement.form.group.name.description'] = 'Name of user group';
...
$l['acp.userManagement.form.group.desc.description'] = 'Description of user group';
...
$l['acp.userManagement.form.success.addUser'] =  'The user was created successfully';
//$l['acp.userManagement.form.success.editUser'] =  'Der Benutzer wurde erfolgreich bearbeitet';
$l['acp.userManagement.form.success.editUser'] =  'The user was edited successfully';
//$l['acp.userManagement.form.success.deleteUser'] =  'Der Benutzer wurde erfolgreich gelöscht';
$l['acp.userManagement.form.success.deleteUser'] =  'The user was deleted successfully';
...
$l['acp.userManagement.form.error.1102.del'] =  'The user could not be deeleted due to lack of write access';
...
$l['acp.userManagement.form.error.del'] =  'The user could not be deleted';
//$l['acp.userManagement.form.success.addGroup'] =  'Die Benutzergruppe wurde erfolgreich erstellt';
$l['acp.userManagement.form.success.addGroup'] =  'The user group has been created successfully';
//$l['acp.userManagement.form.success.editGroup'] =  'Die Benutzergruppe wurde erfolgreich bearbeitet';
$l['acp.userManagement.form.success.editGroup'] =  'The user group has been edited successfully';
//$l['acp.userManagement.form.success.deleteGroup'] =  'Die Benutzergruppe wurde erfolgreich gelöscht';
$l['acp.userManagement.form.success.deleteGroup'] =  'The user group has been deleted successfully';
//$l['acp.userManagement.form.error.1102.group'] =  'Die Benutzergruppe  konnte wegen fehlender Schreibrechte nicht gelöscht werden';
$l['acp.userManagement.form.error.1102.group'] =  'The user group could not be deleted due to lack of write access';
//$l['acp.userManagement.form.error.1112.group'] =  'Der Name der Benutzergruppe  ist schon vergeben';
$l['acp.userManagement.form.error.1112.group'] =  'The name of the user group is already taken';
...
$l['acp.userManagement.form.error.1102.group.del'] =  'The user group could not be deleted due to lack of write access';
//$l['acp.userManagement.form.error.1113.group.del'] =  'Eine System Benutzergruppe darf nicht gelöscht werden';
$l['acp.userManagement.form.error.1113.group.del'] =  'A system user group can not be deleted';
//$l['acp.userManagement.form.error.group'] =  'Die Benutzergruppe konnte nicht gespeichert werden';
$l['acp.userManagement.form.error.group'] =  'The user group could not be saved';
//$l['acp.userManagement.form.error.group.del'] =  'Die Benutzergruppe konnte nicht gelöscht werden';
$l['acp.userManagement.form.error.group.del'] =  'The user group could not be deleted';
//$l['acp.userManagement.form.error.id.group'] =  'Ungültige Gruppen ID';
$l['acp.userManagement.form.error.id.group'] =  'Invalid group ID';

//Rechte
//Rights

//$l['acp.userManagement.premissions.shc.ucp.viewUserAtHome'] =  'Benutzer zu Hause';
$l['acp.userManagement.premissions.shc.ucp.viewUserAtHome'] =  'User at home';
...
$l['acp.userManagement.premissions.shc.ucp.viewUserAtHome.description'] =  'gets the user at home displayed on the index page';
//$l['acp.userManagement.premissions.shc.ucp.warnings'] =  'Warnmeldungen';
$l['acp.userManagement.premissions.shc.ucp.warnings'] =  'Warning messages';
...
$l['acp.userManagement.premissions.shc.ucp.warnings.description'] =  'The user receives a warning message when major functions of the SHC will not run';
//$l['acp.userManagement.premissions.shc.acp.menu'] =  'ACP Menu';
...
$l['acp.userManagement.premissions.shc.acp.menu.description'] =  'enter the APP menu and the functions which do not require to use special permissions';
...
$l['acp.userManagement.premissions.shc.acp.userManagement.description'] =  'Create, edit and delete users and groups';
//$l['acp.userManagement.premissions.shc.acp.settings'] =  'Einstellungen';
$l['acp.userManagement.premissions.shc.acp.settings'] =  'Settings';
//$l['acp.userManagement.premissions.shc.acp.settings.description'] =  'Der Benutzer kann die Einstellungen des SHC bearbeiten';
$l['acp.userManagement.premissions.shc.acp.settings.description'] =  'The user can edit the settings of SHC';
//$l['acp.userManagement.premissions.shc.acp.databaseManagement'] = 'Datenbank';
$l['acp.userManagement.premissions.shc.acp.databaseManagement'] = 'Database';
//$l['acp.userManagement.premissions.shc.acp.databaseManagement.description'] =  'Datenbank überwachen';
$l['acp.userManagement.premissions.shc.acp.databaseManagement.description'] =  'Monitor database';
...
$l['acp.userManagement.premissions.shc.acp.backupsManagement.description'] =  'Create, delete and download backups';
//$l['acp.userManagement.premissions.shc.acp.roomManagement'] =  'Räume verwalten';
$l['acp.userManagement.premissions.shc.acp.roomManagement'] =  'Manage rooms';
//$l['acp.userManagement.premissions.shc.acp.roomManagement.description'] =  'Räume erstellen, bearbeiten und löschen';
$l['acp.userManagement.premissions.shc.acp.roomManagement.description'] =  'Create, delete and download rooms';
//$l['acp.userManagement.premissions.shc.acp.switchableManagement'] =  'Schaltfunktionen verwalten';
$l['acp.userManagement.premissions.shc.acp.switchableManagement'] =  'Manage switching functions';
//$l['acp.userManagement.premissions.shc.acp.switchableManagement.description'] =  'der Benutzer kann Sensoren, Schaltelementen und lesbare Elemente verwalten';
$l['acp.userManagement.premissions.shc.acp.switchableManagement.description'] =  'the user can manage sensors, switching elements and readable elements';
//$l['acp.userManagement.premissions.shc.acp.conditionsManagement'] =  'Bedingungen verwalten';
$l['acp.userManagement.premissions.shc.acp.conditionsManagement'] =  'Manage conditions';
...
$l['acp.userManagement.premissions.shc.acp.conditionsManagement.description'] =  'the user can create and manage conditions';
//$l['acp.userManagement.premissions.shc.acp.switchpointsManagement'] =  'Schaltpunkte verwalten';
$l['acp.userManagement.premissions.shc.acp.switchpointsManagement'] =  'Manage switching points';
...
$l['acp.userManagement.premissions.shc.acp.switchpointsManagement.description'] =  'the user can create and manage switch points';
//$l['acp.userManagement.premissions.shc.acp.sensorpointsManagement'] =  'Sensorpunkte verwalten';
$l['acp.userManagement.premissions.shc.acp.sensorpointsManagement'] =  'Manage sensor points';
//$l['acp.userManagement.premissions.shc.acp.sensorpointsManagement.description'] =  'der Benutzer kann Sensorpunkte verwalten';
$l['acp.userManagement.premissions.shc.acp.sensorpointsManagement.description'] =  'the user can manage sensor points';
//$l['acp.userManagement.premissions.shc.acp.usersathomeManagement'] =  'Benutzer zu Hause verwalten';
$l['acp.userManagement.premissions.shc.acp.usersathomeManagement'] =  'Manage users at home';
...
$l['acp.userManagement.premissions.shc.acp.usersathomeManagement.description'] =  'Users at home can be managed';
//$l['acp.userManagement.premissions.shc.acp.eventsManagement'] =  'Ereignisse verwalten';
$l['acp.userManagement.premissions.shc.acp.eventsManagement'] =  'Manage events';
//$l['acp.userManagement.premissions.shc.acp.eventsManagement.description'] =  'der Benutzer kann Ereignisse verwalten';
$l['acp.userManagement.premissions.shc.acp.eventsManagement.description'] =  'the user can manage events';
//$l['acp.userManagement.premissions.shc.acp.switchserverManagement'] =  'Schaltserver verwalten';
$l['acp.userManagement.premissions.shc.acp.switchserverManagement'] =  'Manage switching server';
//$l['acp.userManagement.premissions.shc.acp.switchserverManagement.description'] =  'der Benutzer kann die Schaltserver verwalten';
$l['acp.userManagement.premissions.shc.acp.switchserverManagement.description'] =  'the user can manage the switching server';
