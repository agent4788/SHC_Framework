...
$l['acp.settings.form.sunriseOffset.decription'] = 'mit dieser Einstellung kann der errechnete Sonnenaufgang um bis zu 180min verschoben werden';
$l['acp.settings.form.sunsetOffset'] = 'Offset Sonnenuntergang';
$l['acp.settings.form.sunsetOffset.decription'] = 'mit dieser Einstellung kann der errechnete Sonnenuntergang um bis zu 180min verschoben werden';
