...
$l['acp.daemonState.box.deamon.task'] = 'Task';
$l['acp.daemonState.box.deamon.arduinoSensorReciver'] = 'Arduino Sensor Empfänger';
$l['acp.daemonState.box.deamon.sensorDataReciver'] = 'Sensor Empfänger';
$l['acp.daemonState.box.deamon.sensorDataTransmitter'] = 'Sensor Sender';
