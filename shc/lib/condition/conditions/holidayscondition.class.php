...
class HolidaysCondition extends AbstractCondition {
    ...
    public function isSatisfies() {
        ...
        if($holidays &= GermanHolidays::NEW_YEARS_DAY && $germanHolidays->getNewYearsDay()->format('dmY') == $dateNow) {
            ...
            return false;
        } elseif($holidays & GermanHolidays::CORPUS_CHRISTI && $germanHolidays->getCorpusChristi()->format('dmY') == $dateNow) {
            ...
            return false;
        } elseif($holidays & GermanHolidays::ASSUMPTION && $germanHolidays->getAssumption()->format('dmY') == $dateNow) {
