...
/**
 * Bedingung Benutzer nicht zu Hause
 *
 ...
 * @version    2.0.0-0
 */
class UserNotAtHomeCondition extends AbstractCondition {
    ...
    public function isSatisfies() {
        ...
        foreach ($usersAtHome as $userAtHome) {
            ...
            /* @var $userAtHome \SHC\UserAtHome\UserAtHome */
            if(in_array($userAtHome->getId(), $usersAtHomeIds) && $userAtHome->getState() == UserAtHome::STATE_OFFLINE) {
