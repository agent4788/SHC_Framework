...
class HolidayChooser extends SelectMultiple {
    ...
    public function __construct($name, $holidays = null) {
        ...
        $values = array(
            ...
            GermanHolidays::CORPUS_CHRISTI => array(SHC::getLanguage()->get('acp.conditionManagement.form.holiday.CORPUS_CHRISTI'), ($holidays & GermanHolidays::CORPUS_CHRISTI ? 1 : 0)),
            GermanHolidays::ASSUMPTION => array(SHC::getLanguage()->get('acp.conditionManagement.form.holiday.ASSUMPTION'), ($holidays & GermanHolidays::ASSUMPTION ? 1 : 0)),
