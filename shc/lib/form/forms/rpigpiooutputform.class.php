...
class RpiGpioOutputForm extends DefaultHtmlForm {
    ...
    public function __construct(RpiGpioOutput $rpiGpioOutput = null) {
        ...
        $switchServer = new SwitchServerChooser('switchServer', ($rpiGpioOutput instanceof RpiGpioOutput ? $rpiGpioOutput->getSwitchServer() : 0));
        ...
        //Aktiv/Inaktiv
        $enabled = new OnOffOption('enabled', ($rpiGpioOutput instanceof RpiGpioOutput ? $rpiGpioOutput->isEnabled() : false));
        ...
        //Sichtbarkeit
        $visibility = new OnOffOption('visibility', ($rpiGpioOutput instanceof RpiGpioOutput ? $rpiGpioOutput->isVisible() : false));
