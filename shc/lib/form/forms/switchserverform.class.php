...
class SwitchServerForm extends DefaultHtmlForm {
    ...
    public function __construct(SwitchServer $switchServer = null) {
        ...
        $model->setValues(array(
            ...
            Arduino::ESP8266_01 => array('ESP8266-01', ($switchServer instanceof SwitchServer && $switchServer->getModel() == Arduino::DUE ? 1 : 0)),
            Arduino::ESP8266_12 => array('ESP8266-12', ($switchServer instanceof SwitchServer && $switchServer->getModel() == Arduino::DUE ? 1 : 0))
        ));
