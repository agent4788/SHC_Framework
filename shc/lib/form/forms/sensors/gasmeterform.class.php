 ...
 * @version    2.0.0-0
 */
class GasMeterForm extends DefaultHtmlForm {

    /**
     * @param GasMeter $sensor
     */
    public function __construct(GasMeter $sensor = null) {
        ...
        //Name des Sensors
        $name = new TextField('name', ($sensor instanceof GasMeter ? $sensor->getName() : ''), array('minlength' => 3, 'maxlength' => 40));
        ...
        //Icon
        $icon = new IconChooser('icon', ($sensor instanceof GasMeter ? ($sensor->getIcon() != '' ? $sensor->getIcon() : 'shc-icon-gasmeter') : ''));
        ...
        //Raeume
        $rooms = new RoomChooser('rooms', ($sensor instanceof GasMeter && count($sensor->getRooms()) > 0 ? $sensor->getRooms(): array()));
        ...
        //Sichtbarkeit
        $visibility = new OnOffOption('visibility', ($sensor instanceof GasMeter ? $sensor->isVisible() : true));
        ...
        //Menge Sichtbar
        $fluidAmountVisibility = new OnOffOption('fluidAmountVisibility', ($sensor instanceof GasMeter ? $sensor->isFluidAmountVisible() : true));
        ...
        //Daten Aufzeichnung
        $dataRecording = new OnOffOption('dataRecording', ($sensor instanceof GasMeter ? $sensor->isDataRecordingEnabled() : false));
