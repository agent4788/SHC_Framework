 ...
 * @version    2.0.0-0
 */
class InputHighConditionForm extends DefaultHtmlForm {

    /**
     * @param InputHighCondition $condition
     */
    public function __construct(InputHighCondition $condition = null) {
        ...
        //Name der Aktivitaet
        $name = new TextField('name', ($condition instanceof InputHighCondition ? $condition->getName() : ''), array('minlength' => 3, 'maxlength' => 25));
        ...
        //Eingaenge
        $inputs = new InputChooser('inputs', ($condition instanceof InputHighCondition ? $condition->getData()['inputs'] : array()));
        ...
        //Aktiv/Inaktiv
        $enabled = new OnOffOption('enabled', ($condition  instanceof InputHighCondition ? $condition->isEnabled() : true));
