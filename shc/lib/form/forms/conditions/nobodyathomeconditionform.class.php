 ...
 * @version    2.0.0-0
 */
class NobodyAtHomeConditionForm extends DefaultHtmlForm {

    /**
     * @param NobodyAtHomeCondition $condition
     */
    public function __construct(NobodyAtHomeCondition $condition = null) {
        ...
        //Name der Aktivitaet
        $name = new TextField('name', ($condition instanceof NobodyAtHomeCondition ? $condition->getName() : ''), array('minlength' => 3, 'maxlength' => 25));
